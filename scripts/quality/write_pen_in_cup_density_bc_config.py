...
LOW_DIM_BY_CONDITION = {
    ...
    "proprio_euler": ["robot0_eef_pos", "robot0_eef_euler", "robot0_gripper_qpos"],
    "exterior_proprio_euler": ["robot0_eef_pos", "robot0_eef_euler", "robot0_gripper_qpos"],
    "wrist_proprio_euler": ["robot0_eef_pos", "robot0_eef_euler", "robot0_gripper_qpos"],
    "image": [],
    "state": ["robot_state"],
...
RGB_BY_CONDITION = {
    ...
    "proprio_euler": [],
    "exterior_proprio_euler": ["agentview_image"],
    "wrist_proprio_euler": ["robot0_eye_in_hand_image"],
